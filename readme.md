...
1. Generate the documentation into their specific folders - ARKAmarach, ARKCube, ARKPlatform, etc. Documentation can be generated using using [WIDOCO](https://github.com/dgarijo/Widoco) (jar available in the repository)
